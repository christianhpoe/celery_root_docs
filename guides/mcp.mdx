...
```python
from celery_cnc import CeleryCnCConfig, McpConfig
...
- `CELERY_CNC_MCP_ENABLED` (derived from config)
- `CELERY_CNC_MCP_HOST`
- `CELERY_CNC_MCP_PORT`
- `CELERY_CNC_MCP_PATH`
- `CELERY_CNC_MCP_AUTH_KEY`
...
```bash
export CELERY_CNC_MCP_READONLY_DB_URL="postgresql://readonly:..."
```
